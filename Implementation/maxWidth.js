...
function maxHeight(t) {
   ...
   return max(1 + maxHeight(t.left), 1 + maxHeight(t.right))
...
function maxWidth(level, t) {
   ...
   child[level] += 1
   if(t.left) {
      maxWidth(level + 1, t.left)
   }

   if(t.right) {
      maxWidth(level + 1, t.right)
   }
   return
